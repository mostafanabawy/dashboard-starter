...
export class AppService {
    ...
    toggleLanguage(item: any) {
        ...
        if (item) {
            ...
            item = this.storeData.languageList.find((languageListItem: any) => languageListItem.code === code);
            if (item) {
                lang = item;
            }
        }
        ...
        if (!lang) {
            lang = this.storeData.languageList.find((languageListItem: any) => languageListItem.code === 'en');
        }
